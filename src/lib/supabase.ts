...
// Types for database
export type UserRole = 'tenant' | 'landlord' | 'admin' | 'user';
export type UserStatus = 'pending' | 'active' | 'blocked';
export type ServiceType = 'colis' | 'gaz' | 'lessive' | 'poubelles' | 'nettoyage' | 'logement' | 'personnel';
export type SubscriptionStatus = 'pending' | 'active' | 'expired';
export type RequestStatus = 'new' | 'approved' | 'rejected' | 'in_progress' | 'completed' | 'processed' | 'cancelled';
export type ServiceTypeValue = 'colis' | 'gaz' | 'lessive' | 'poubelles' | 'nettoyage' | 'demenagement' | 'personnel';
