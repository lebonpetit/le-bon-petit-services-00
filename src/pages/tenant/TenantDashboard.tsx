...
import { Search, Home, MapPin, MessageCircle, Phone, LogOut, CreditCard, Eye, Calendar } from 'lucide-react';
...
export default function TenantDashboard() {
    ...
    const handleLogout = async () => {
        ...
        toast({
            ...
            description: "À bientôt sur Le Bon Petit !",
        });
    };
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                    <div>
                        ...
                        <p className="text-muted-foreground">Trouvez le logement de vos rêves</p>
                    </div>
                    <div className="flex items-center gap-3">
                        <Link to="/tenant/subscription">
