...
import { Eye, EyeOff, UserPlus, Home, AlertCircle, User, Mail, Lock, ArrowRight, ArrowLeft, Check, Phone } from 'lucide-react';
                    ...
                    <CardContent>
                        ...
                        <div className="mb-8">
                            ...
                            <div className="relative h-1.5 bg-secondary rounded-full mb-6 overflow-hidden">
                                <div
                                    className="absolute top-0 left-0 h-full bg-gradient-to-r from-african-yellow to-african-gold rounded-full transition-all duration-500 ease-out"
                                        ...
                                        <div className="mt-2 p-3 rounded-xl bg-secondary/50 border border-border/50">
                                            ...
                                            <div className="space-y-1">
                                                <p className="text-sm flex items-center gap-2">
                                                    <User className="h-3.5 w-3.5 text-african-yellow" />
                                                    {formData.name}
                                                </p>
                                                <p className="text-sm flex items-center gap-2">
                                                    <Mail className="h-3.5 w-3.5 text-african-yellow" />
                                                    {formData.email}
                                                </p>
                                            </div>
                                        </div>
