                                ...
                                <Card className="border-none shadow-2xl rounded-[2rem] overflow-hidden bg-white dark:bg-card">
                                    ...
                                    <CardContent className="p-8 md:p-12 space-y-8">
                                        ...
                                        <div className="grid grid-cols-2 gap-6">
                                            <div className="space-y-2">
                                                <Label>Prénom *</Label>
                                                <Input placeholder="Kouam" className="h-12 bg-secondary/30 border-transparent focus:border-african-yellow" value={reservationForm.prenom} onChange={(e) => setReservationForm({ ...reservationForm, prenom: e.target.value })} />
                                            </div>
                                            <div className="space-y-2">
                                                <Label>Nom *</Label>
                                                <Input placeholder="Tchamda" className="h-12 bg-secondary/30 border-transparent focus:border-african-yellow" value={reservationForm.nom} onChange={(e) => setReservationForm({ ...reservationForm, nom: e.target.value })} />
                                            </div>
                                        </div>
                                        <div className="space-y-2">
