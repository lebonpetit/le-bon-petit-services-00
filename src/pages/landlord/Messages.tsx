...
import { ArrowLeft, MessageCircle, Send, Home, User as UserIcon, Clock } from 'lucide-react';
                                    ...
                                    {selectedConversation.messages.map((message, index) => (
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <p className={`text-xs mt-1 ${message.from_user === user?.id ? 'text-primary-foreground/70' : 'text-muted-foreground'
                                                    }`}>
