...
import { Plus, Home, MapPin, Eye, MessageCircle, LogOut, Edit, Trash2, Building2 } from 'lucide-react';
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                    <div>
                        ...
                        <p className="text-muted-foreground">Gérez vos logements en toute simplicité</p>
                    </div>
